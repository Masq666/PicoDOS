...
;;		   ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´				    ;;
;;		   ³  MiniDOS Load Address  ³ 0060			    ;;
;;		   ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´				    ;;
;;		   ³	File Load Address   ³ 1010			    ;;
;;		   ÃÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´				    ;;
...
;;									    ;;
;;  NOTE: ;****  = Modded to run Mini-Dos, by Dex(Craig Bamford)	    ;;
;;  Also modded to assemble with fasm.					    ;;
;;									    ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
main:
	...
	mov	[bsDriveNumber], 00	; store boot drive number
...
;**************************************************
	pusha				; Loads the root dir to a safe place.
	push	es
	push	ds
	push	[ImageLoadSeg]
	pop	ds
...
;;;;;;;;;;;;;;;;;;;
	...
	mov	es, ax
;**************************************************
	mov	[ImageLoadSeg],0x1010	; New address to load image
;**************************************************
...
ProgramName	db	"PICODOS SYS"	; name and extension must be padded
